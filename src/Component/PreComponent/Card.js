...
<div className="icon-box w-16 md:w-20 h-16 md:h-20 rounded-full overflow-hidden bg-white flex justify-center items-center ">
    {props.icon}
</div>

<div className="text flex flex-col justify-center items-center w-2/3 h-full ">
    <div className="font-bold text-purple-700 text-3xl h-1/2">{props.quantity}</div>
